      ...
      >
        ...
        <div className="sticky top-0 flex flex-col items-start justify-center gap-4 h-screen max-w-4xl w-full">
          ...
          <motion.div
            ...
            className="inline-flex items-center px-5 py-2 border border-purple bg-white rounded-full shadow-lg mb-5"
          >
            <p className="text-sm font-medium text-primary lowercase">
              about
            </p>
          </motion.div>
